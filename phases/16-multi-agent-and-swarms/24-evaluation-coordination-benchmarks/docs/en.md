...
arXiv:2509.xxxxx / OpenReview. 1865 problems across 41 repos and 123 languages. Designed to be **uncontaminated** with later training cutoffs. Frontier models score ~23% on Pro vs 70%+ on Verified. The gap is the contamination signal.
